...
export default function SignUp() {
    return (
        <div className="h-screen flex justify-center items-center bg-black">
            <div className="flex w-full h-[80vh] bg-blackrounded-lg overflow-hidden shadow-lg p-6">
                ...
                <div className="bg-black text-white pl-6 pr-6 pb-6 lg:w-[50%] w-[100%] h-full flex flex-col justify-between overflow-y-auto custom-scrollbar">
                    <div>
                        ...
                        <h2 className="font-newfont font-normal mb-4 text-center">Create Account to access our services</h2>
                        <div>
                            <h2 className="font-newfont font-bold mb-2">User Name</h2>
                            <input type="text" placeholder="Username" className="font-newfont p-3 rounded-lg bg-[#27272a] border-2 border-gray-500 w-full hover:border-[#E21D48] mb-4" />
                        </div>
                        <div>
                        ...
                        <div>
                            <button className="font-newfont font-extrabold text-lg p-3 rounded-lg bg-[#1e1e1f] border-2 border-gray-500 w-full hover:border-[#E21D48] flex gap-4 justify-center mb-4">
                                Sign Up <FaArrowRightLong className="mt-1 text-sm" />
                            </button>
                        </div>
                    </div>
                    <div className="flex flex-col gap-4">
                        ...
                        <h2 className="text-center text-slate-200 cursor-pointer">
                            Already have an account? <span className="ml-1 text-blue-600 underline hover:text-[#E21D48]"><Link to={'/Signin'}>SignIn</Link></span>
                        </h2>
                    </div>
                </div>
            </div>
